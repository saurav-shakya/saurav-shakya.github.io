...
I spend my days coding, tinkering with AI, and writing about what I pick up along the way. If startups, AI, or building products excite you too, let's talk.
...
### 1. [Plany.Space](https://plany.space/)
An AI-powered planning and productivity app with a timeline-based interface, built with a long-term vision and real user feedback.
📲 Download: [Plany on Google Play](https://play.google.com/store/apps/details?id=com.timelineapp)

### 2. [cli-share](https://github.com/saurav-shakya/cli-share)
Share your terminal conversations instantly as professional GitHub Gists. 900+ downloads by developers worldwide.
🎥 Demo: [Watch on X](https://x.com/sauravv_x/status/2046304601515950271?s=20)

### 3. Attention is All You Need (AAYN)
A browser extension designed to enhance focus while watching YouTube by intelligently managing video suggestions and distractions.
🎥 Demo: [Watch on X](https://x.com/sauravv_x/status/1881226836123975778?s=20)
🔗 [LinkedIn post](https://www.linkedin.com/posts/saurav-shakya_i-built-this-chrome-extension-for-my-cousin-share-7376236790892056576-pbA1/)

### 4. [PickUp](https://github.com/saurav-shakya/PickUp)
Session restore for Ubuntu. PickUp fixes that with one command.

More of my work here  **[x.com/sauravv_x/highlights](https://x.com/sauravv_x/highlights)**
